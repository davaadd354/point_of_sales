        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="md:flex md:items-center md:justify-between mb-6">
                <div class="min-w-0 flex-1">
                    <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Edit Data Produk</h2>
                </div>
            </div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-6 text-gray-900">
                    
                    <form action="{{route('saveEditProduk')}}" method="POST" class="space-y-4 sm:space-y-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="berat" id="berat" required value="{{$produk->berat}}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="harga_pcs" id="harga_pcs" required value="{{$produk->harga_pcs}}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="harga_grosir" id="harga_grosir" required value="{{$produk->harga_grosir}}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            ...
                            <div class="space-y-2">
                                ...
                                <img id="imagePreview" class="mt-2 {{$produk->file_name ? '' : 'hidden'}} w-full md:w-1/2 h-auto rounded-md" src="{{$produk->url_gambar}}" />
                            </div>
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" id="upc" name="upc" value="{{$produk->upc}}" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="Masukan kode Barcode Produk" required="">
                                </div>
                            </div>
                        </div>
